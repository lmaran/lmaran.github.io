...
![](/assets/images/2015/06-01-gulp-build-and-watch.png)
...
gulp.task("dev", function (cb) {
  runSequence("clean-css", "less", "build-dev-html", "jshint", cb);
});
```
...
gulp.task("dev:watch", function (cb) {
  runSequence("dev", ["livereload", "watch"], cb);
});
```
...
<html ng-app="app">
  ...
  <body>
    <h2>Gulp Demo</h2>
    <div ng-class="demoClass" ng-controller="demoController">
      {{itemValue | json}}
    </div>
    <!-- cdn -->
...
![](/assets/images/2015/05-30-gulp-err-in-code.png)

atunci aceste erori le pot depista in procesul de build - faza de analiza a codului:

![](/assets/images/2015/05-30-gulp-err-in-jshint.png)
