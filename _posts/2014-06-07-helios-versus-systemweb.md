...
![OwinStack](/assets/images/2014/owin-stack.png)
...
![](/assets/images/2014/perfmon-all-ab.png)

Nu incercati sa-l intelegeti :-), am sa-l iau pe rand:

### 3.1. Consum de CPU

![](/assets/images/2014/perfmon-cpu-ab.png)
...
![](/assets/images/2014/perfmon-req-ab.png)
...
![](/assets/images/2014/perfmon-bytes-ab.png)
...
![](/assets/images/2014/perfmon-asm-ab.png)

Acelasi rezultat il poti obtine apeland din cod (sau in _Immediate Window_) metoda:
...
Punand un _break point_ pe ultima linie din `Startup.cs` si urmarind apelurile de pe stiva te poti convinge ca in pipeline-ul Http nu mai apare nicio referinta la System.Web. Cele 2 biblioteci instalate (Loader.IIS si Host.IIS) fac aproape toata treaba:

![](/assets/images/2014/helios-callstack.png)
...
![](/assets/images/2014/helios-modules.png)
