...
![](/assets/images/2014/default-webapi-first-page.png)
...
![](/assets/images/2014/chrome-api-values-result.png)
...
![](/assets/images/2014/ff-api-values-result.png)
...
![](/assets/images/2014/ie-api-values-result.png)
...
![](/assets/images/2014/ie-api-values-result-as-json.png)
...
![](/assets/images/2014/request-header-chrome-extension.png)
...
![](/assets/images/2014/change-http-request-header.png)

- optiunea **User-Agent** este definita by default. Vom adauga optiunea **Accept**:

![](/assets/images/2014/change-http-request-header-add-accept.png)

- adauga in campul "Presets" valoarea: `text/html, application/xhtml+xml, */*` (aceeasi valoare ca si in cazul IE)

![](/assets/images/2014/change-http-request-header-add-accept-value.png)
...
![](/assets/images/2014/change-http-request-header-add-accept-value-select.png)

- in acest moment ar trebui ca rezultatul returnat sa fie in **format JSON** (in loc de XML):

![](/assets/images/2014/webapi-response-json-chrome.png)
...
- (optional) in bara de _search_ filtrezi dupa cuvantul "accept"
...
![](/assets/images/2014/change-http-accept-header-value-ff.png)

...si testul care iti confirma ca raspunsul este cel asteptat:

![](/assets/images/2014/webapi-response-json-ff.png)
